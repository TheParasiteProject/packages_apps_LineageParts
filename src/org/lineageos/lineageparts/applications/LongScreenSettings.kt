...
class LongScreenSettings: Fragment(R.layout.long_screen_layout) {
    ...
    private lateinit var longScreen: LongScreen
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        longScreen = LongScreen(requireContext())
    }

    private fun getTitle(): Int {
        return R.string.long_screen_settings_title
    }
    ...
    private fun getInitialCheckedList(): List<String> {
        val flattenedString = LineageSettings.System.getString(
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        optionsMenu = menu;
        inflater.inflate(R.menu.long_screen_menu, menu)
    ...
    private fun onListUpdate(packageName: String, isChecked: Boolean) {
        ...
        for (info in userInfos) {
            if (isChecked) {
                longScreen.addApp(packageName, info.id)
            } else {
                longScreen.removeApp(packageName, info.id)
            }
        }
        try {
    ...
    private fun getKey(): String {
        return LineageSettings.System.LONG_SCREEN_APPS
    }
        ...
        var list = packageList.filter {
            if (!showSystem) {
                ...
                && !resources.getStringArray(
                        R.array.long_screen_settings_hidden_apps)
